...
export function StoreSwitcher() {
  ...
  if (!selectedStore || stores.length <= 1) {
    ...
    if (selectedStore) {
      return (
        <div className="flex items-center gap-2 px-3 py-1.5 bg-white/80 border border-gray-200/50 rounded-lg">
          <div
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 bg-white/80 hover:bg-white border border-gray-200/50 rounded-lg transition-all duration-200"
      >
        <div
          className="w-3 h-3 rounded-full flex-shrink-0"
          style={{ backgroundColor: selectedStore.color || '#6366f1' }}
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-1 w-56 bg-white rounded-xl border border-gray-200/50 shadow-lg py-1 z-50">
