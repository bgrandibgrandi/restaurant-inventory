...
export default function EditRecipePage() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Convert existing steps to local format
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4">
              <Link href={`/recipes/${params.id}`} className="text-gray-500 hover:text-gray-700 transition">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Update your recipe details</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <button
                ...
                disabled={improving}
                className="inline-flex items-center px-4 py-2 bg-purple-100 hover:bg-purple-200 text-purple-700 text-sm font-semibold rounded-xl transition disabled:opacity-50"
                title="Fix typos and improve formatting with AI"
              >
                <svg className="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
                {improving ? 'Improving...' : 'AI Fix'}
              </button>
              <button
              ...
              <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Give your recipe a memorable name</p>
                  </div>
                </div>
