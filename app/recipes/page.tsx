                  ...
                  <div className="flex items-center gap-4 flex-1 min-w-0">
                    {recipe.imageUrl ? (
                      <img
                        src={recipe.imageUrl}
                        alt={recipe.name}
                        className="w-14 h-14 object-cover rounded-xl flex-shrink-0 ring-2 ring-white shadow-md group-hover:scale-105 transition-transform"
                      />
                    ) : (
                      <div className="w-14 h-14 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex-shrink-0 flex items-center justify-center group-hover:scale-105 transition-transform">
