        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mt-8 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              <Link href="/recipes" className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition text-center">
                ...
                <span className="text-sm font-medium text-gray-700">Recipes</span>
              </Link>
